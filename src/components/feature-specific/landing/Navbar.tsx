          ...
          <div className="hidden md:flex gap-10 items-center">
            {links.map((item, i) => {
              ...
              return (
                ...
                >
                  {item.label}
                  <span className={`absolute -bottom-1.5 left-0 h-0.5 transition-all duration-300 ${
                    isActive ? "w-full bg-purple-600" : "w-0 bg-purple-600 group-hover:w-full"
                  }`} />
                </a>
              );
            })}
        ...
        {menuOpen && (
          ...
          >
            ...
            <div className="flex justify-between items-center px-6 py-5 border-b border-gray-100">
              <a href="#home" onClick={() => setMenuOpen(false)} className="flex items-center gap-3 font-extrabold text-2xl tracking-tighter text-[#1a1a2e]">
                ...
                return (
                  <motion.a
                    ...
                    className={`text-3xl font-bold transition-colors ${
                      isActive ? "text-purple-600" : "text-[#1f2937] hover:text-purple-600"
                    }`}
                  >
                    {item.label}
                  </motion.a>
            ...
            <div className="mt-auto p-8 border-t border-gray-100 bg-gray-50/50">
              <motion.a
                ...
                href="#contact"
                onClick={() => setMenuOpen(false)}
                className="block w-full text-center py-4 bg-gradient-to-r from-purple-600 to-pink-500 text-white rounded-2xl font-bold shadow-xl shadow-purple-100"
              >
                Contact us →
              </motion.a>
