...
export function AdminLoginForm() {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      window.location.href = "/next-api/auth/admin";
    } catch {
  ...
  return (
    ...
    >
      ...
      <div className="mt-10 space-y-6">
        ...
        <Button
          className="relative h-12 w-full overflow-hidden rounded-xl bg-white font-semibold text-slate-950 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70"
